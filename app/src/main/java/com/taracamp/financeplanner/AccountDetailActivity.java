...
public class AccountDetailActivity extends AppCompatActivity {
     ...
     * Controls
     *############################################################################################*/
    private TextView accountDetailTextView;
    ...
    private void _initializeControls(){
        this.accountDetailTextView = findViewById(R.id.accountDetailTextView);
    ...
    private void _loadData(User currentUser){
        ...
        int position;
        if(extras != null) position = extras.getInt("POSITION");
        else position = 0;

        this.accountDetailTextView.setText(Integer.toString(position));
    }
}
